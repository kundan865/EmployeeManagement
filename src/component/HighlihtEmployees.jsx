...
const HighlightEmployees = () => {
    ...
    const highlightEmployees = employees.filter(emp => emp.highlight===true);
    // console.log(highlightEmployees)

    return (
        <Layout>
            <ul className="list bg-base-100 rounded-box shadow-md mt-1">

                {highlightEmployees.length === 0 && <p>No Heightligh Employees</p>}

                {highlightEmployees.map((employee) =>
...
export default HighlightEmployees
